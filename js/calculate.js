...
function loadcode(code = "") {
	...
	var encodedvalues = JSON.parse(getData("https://cors.bridged.cc/https://jsonbase.com/pwcalctest/", code.toUpperCase()));
...
function makeid(length) {
	var result = '';
	var characters = 'ABCDEGHKMNOPQRSTUVWXYZ2345678';
